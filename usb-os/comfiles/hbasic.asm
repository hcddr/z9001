...
; Achtung Grafik-Erw geht nicht! Der Treiber überlagert das Basic!
...
p_printat	equ	0	;PRINT AT über CALL 5 statt direktem Schreiben in den BWS
p_printatw	equ	0	;Window auf vollen Bildschrim setzen

;V. Pohlers 14.12.2009
p_80z		equ	0	;Änderung WINDOW f. max. 80 Zeichen/Zeile f. CRT80
