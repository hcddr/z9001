...
; ist i.W. der originale OS-Treiber, aber Nutzung Grafikmodus
;
...
ICRT:	DI			;INITIALISIERUNG CRT
	...
	LD	H,29H		;EINSTELLEN (40 Spalten)
	LD	(P3ROL),HL	;
	LD	H,0
	LD	(COUNT),HL	;
...
labinv		nop
		...
		inc	de
		call	nextbws		;naechste BS-Zeile
		and	0111b		;A = BWS
...
bws		ds	1
sysbuff:	equ	80h		; DMA-Pufferbereich
