...
biosend		equ	$
	...
	message	       "cpm:		\{ccp}H"
	message	       "bdos:		\{bdos}H"
	message	       "ubios:		\{ubios}H - \{ubios_end1}H"
	message	       "RAM-Disk:	\{rafmini.RDSK}H - \{rafmini.RDSKEND}H"
	message	       "codeend:	\{biosend}H"
	message	       "====================="
	;endif

	if ubios_end1 > rafmini.RDSK
		error "UBIOS überschneidet sich mit RAM-Disk!"
	endif
