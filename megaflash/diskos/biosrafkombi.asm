;------------------------------------------------------------------------------
; RAM-Disk 406k / 58k f. Kombi-Modul / 64K-SRAM-Modul  DISKOS-Version
...
; Disketten-Treiber
; global genutzt dtrack, dsec, ddrive	
...
rafkombi.codeadr	equ	0150h	; Freier Bereich
...
; Lesen von Diskette
rafkombi.READ:	CALL	rafkombi.READ1
		; ins ziel kopieren
		ld	hl, rafkombi.dma
		ld	de, biosbuf
		ld	bc, 0080h
...
rafkombi.WRITE:	; aus quelle kopieren
		ld	hl, biosbuf
		ld	de, rafkombi.dma
		ld	bc, 0080h
		ldir
...
rafkombi.adre4:	;normal
		...
		;
		;Bank b
		;;LD	DE,(ddma)	; vorher setzen - gleich ist sie weg
