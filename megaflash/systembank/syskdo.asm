...
; 03.03.2019 save ohne Parameter speichert mit aktuellem FCB
;------------------------------------------------------------------------------
...
J_KDO:		call	KDOPAR
		ld	a, e			;Bank
		or	a			;2. Parameter 0
		jr	z, JKO1			; dann mit Systembank starten
		; Start mit Bank
		push	hl			;Startadr.
		jp	setbk1			;Bank schalten und Programm starten
		; Start ohne Bank
JKO1:		jp	(HL)			;und Pgm. starten
;
