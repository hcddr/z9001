...
;
dirkdo0:	call	vdip_init	; Synchronisation
		jp	c,exit
...
cdkdob1:		ld	HL, "DC"	; 'CD' restaurieren wurde von GVAL gelöscht
		ld	(CONBU+2), HL
		jp	usbkdo		; Wir nutzen einfach "USB CD xxx"

;ohne Parameter: Anzeige möglicher Verzeichnisse
