'--------------------------------------------------------
'Systeminfo V.Pohlers 18.05.2013, 18.06.2015
'jkcemu 0.93
'java -jar %jkcemu% --bc -L DE -B0 -O3 -t Z9001 -A 300 -N SYSINFO -o sysinfo.tap sysinfo_2.2.bas
'--------------------------------------------------------
...
' print hex$(I,2);"-";hex$(I+7,2),
 ...
 ELSEIF I=&HB8 
		OUT (&HB8)=0:Bereich(i):PRINT " Grafikzusatz"
 ELSEIF I=&HC1 
...
DO 
  INK GREEN: PAPER 0:'BLACK
  cls
  PRINT "Systeminfo 2.2  V.Pohlers 13.05.2015"
