;-----------------------------------------------------------------------------
; File Name   :	hobby\z9001 lpro\lpro16.bin
; Format      :	Binary file
...
; "T"
chksum_os13:	dw	0B287h		; BM608 Testdaten OS 1.3
		dw	051B8h          ; BM608 Summe F000-F7FF
chksum_basic86:	dw	0F603h		; Testdaten BASIC-86 (BM608)
		...
		dw	05AA6h          ; Summe C000-C7FF (BM600)        
;
word_887D:	dw 	05FD3h		; M006 Testdaten Idas robotron Modul vp
		dw 	027C5h		; M005
		dw 	0AF47h		; M004
		dw 	0E1F6h		; M003
		dw 	0168Fh     	; M002
...
aTestprogrammZ9:db 39,"TESTPROGRAMM KC85/1 u. KC87 (Vers. 1.6)"
...
aPruefprogrammF:dw 3
		...
		dw 53h
		db 28,"KASSETTENRECORDERS AN DEN KC"
...
csts0:		push	bc
		...
		ret     z
		cp      13h
		jr      z, csts0        ; Abfrage Status CONST
		cp      3
		ret     z
		cp      0Dh
		jr      nz, csts0       ; Abfrage Status CONST
		ret
...
; START OF FUNCTION CHUNK FOR inp_jn
loc_968B:	ld      sp, 200h
                xor     a
                ld      (25h), a
                jr      lpro
...
lpro2:		ld	hl, 0C007h	; Test,	ob ROM-BASIC vorhanden ist
		...
		jr	lpro3
; Test IDAS
loc_96EA:       ld      hl, 0C003h
		ld      a, 49h ; 'I'
		cp      (hl)
		jr      nz, lpro3
		ld      hl, aIdasC000E7ff ; "IDAS: C000-E7FF"
		call    print0
		ld      a, 4
		call    mark_test2
; Test TPRAMF nötig?
...
loc_971F:	call	consi		; Eingabe 1 Zeichen nach A
		cp	3
		jp	z, 0
 		cp      '1'
		jr      c, loc_971F
...
loc_96DD:	call	scroll_up
		...
		ld	b, 8
		call	sub_9528	; Anzeige der auszuführenden Tests
		ld	hl, 311h
		ld	c, (hl)
		ld	hl, aTpsph	; "TPSPH "
		ld	b, 6
...
;-----------------------------------------------------------------------------
; Testprogramm IDAS C000-E7FF
;-----------------------------------------------------------------------------

tpidas:		ld	de, word_887D	; Testprogramm ROM-BASIC C000-E7FF
		jr	tprom21
