...
;ALS I/O-DATEN MOEGLICH
	...
	EXTGO2:	EQU	ROMBEG + 02003H
	EXTGO3:	EQU	ROMBEG + 02006H
	EXTTAB:	EQU	ROMBEG + 02009H
	VERT:	EQU	ROMBEG + 0200BH
;------------------------------------------------
	ENDIF
...
;FOR DIV;DVAR1
	...
	DEFW	983EH
	DEFW	0C752H		;RNDVR4	;.811635
	DEFW	804FH
	DEFB	11		;DUMMY	;ANZ. DER D.-ZEICHEN +1
...
ERROO1:	CALL	TEXTO
	...
	LD	DE,65534
	CALL	CPREG
	JP	Z,PRIST1		;SPRUNG, WENN FEHLER BEI DER
;EINGABE DES RAMBEREICHS
;BEIM KALTSTART
	LD	A,H
	AND	A, L
	INC	A
...
CASS0:	LD	A,D4TYPE	; *.TTT
	INC	HL
	DEFB	1		; folgenden Befehl überspringen
CASS01:	LD	A,D3TYPE	; *.UUU
...
CASS5:	CALL	TCHAR1		; Pointer auf nächstes signifikantes Zeichen
	...
	LD	HL,INTPRB+13	; Print-Buffer mit Leerzeichen füllen
	LD	B,13
CASS2:	DEC	HL
	LD	(HL),' '	; Name loeschen
	DJNZ	CASS2
